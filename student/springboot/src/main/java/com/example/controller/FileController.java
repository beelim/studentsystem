...
public class FileController {
    ...
    public Result upload(MultipartFile file) throws IOException {
        ...
        String fileExtension = StringUtils.getFilenameExtension(originalFilename);  // 获取到原始的文件名   aaa.png   aaa.png
        long flag = System.currentTimeMillis();  // 唯一标识
        String fileName = flag  + "_" + java.util.UUID.randomUUID() + "." + fileExtension;   //  1561231313132_aaa.png
